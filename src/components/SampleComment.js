...
import "../styles/samplecomment.css";
class SampleComment extends Component {
  state = {};
    ...
    return (
      <>
        <div className="sample-comment-container">
          <div className="main-sample-content">
            <div className="user-img-div">
              <img src={this.props.src}></img>
            </div>
            <div className="comment-box">
              <div className="user-info">
                <div className="svg-bin-div" onClick={this.props.onDelete}>
                  <svg className="svg-bin" viewBox="0 0 20 20">
                    <path
                      fill="white"
                ...
                <h4 className="user-name-sample">{this.props.fullname}</h4>
              ...
              <div className="comment-text">
                ...
                <br></br>
                <br></br>
                <h2 className="comment-date">{this.props.date}</h2>
              </div>
            </div>
          </div>
        </div>
